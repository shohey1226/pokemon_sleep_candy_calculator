  ...
  return (
    <div className="">
      ...
      <div className="mb-6">
        ...
        <select name="expType" className="w-full p-3 mt-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" value={formValues.expType} onChange={handleChange}>
      ...
      <div className="mb-6">
        <p className="text-gray-800 font-semibold">Candy Required: <span className="font-normal">{outValues?.calcRequiredCandy}</span></p>
        <p className="text-gray-800 font-semibold">Dream Shards Required: <span className="font-normal">{outValues?.calcRequiredDreamShards}</span></p>
        <p className="text-gray-800 font-semibold">Experience Required: <span className="font-normal">{outValues?.calcRequiredExp}</span></p>
      </div>
      <button className="w-full p-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500" onClick={()=> dispatch({ type: 'ADD_POKEMON', payload: outValues })}>Add Pokemon</button>
    </div>
  );
}
